  ...
  return (
    <section className='project'>
      <div className="container">
        ...
        <Title content={MOCK.p_0002_title} />

        <Description content={MOCK.p_0002_d_1} project={true} />
        <br />
        ...
        <Description content={MOCK.p_0002_d_2} project={true} />
        <br />
        <Description content={MOCK.p_0002_d_3} project={true} />
        <br />
        ...
        <Description content={MOCK.p_0002_d_4} project={true} />
        <br />
        <Description content={MOCK.p_0002_d_5} project={true} />
        <br />
        <Description content={MOCK.p_0002_d_6} project={true} />
        <br />
      ...
      <div className="container">
        <Description content={MOCK.p_0002_d_7} project={true} />
        <br />
        <Description content={MOCK.p_0002_d_8} project={true} />
        <br />
        ...
        <Description content={MOCK.p_0002_d_9} project={true} />
        <br />
        <Description content={MOCK.p_0002_d_10} project={true} />
        <br />
        <Description content={MOCK.p_0002_d_11} project={true} />
        <br />
        ...
        <Description content={MOCK.p_0002_d_12} project={true} />
        <br />
      </div>
