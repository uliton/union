  ...
  return (
    <section className='project'>
      <div className="container">
        ...
        <Description content={MOCK.p_0006_d_1} project={true} />
        <br />
        ...
        <Description content={MOCK.p_0006_d_2} project={true} />
        <br />
        <Description content={MOCK.p_0006_d_3} project={true} />
        <br />
        ...
        <Description content={MOCK.p_0006_d_4} project={true} />
        <br />
        <Description content={MOCK.p_0006_d_5} project={true} />
        <br />
      ...
      <div className="container">
        <Description content={MOCK.p_0006_d_6} project={true} />
        <br />
        <Description content={MOCK.p_0006_d_7} project={true} />
        <br />
        ...
        <Description content={MOCK.p_0006_d_8} project={true} />
        <br />
        <Description content={MOCK.p_0006_d_9} project={true} />
        <br />
        ...
        <Description content={MOCK.p_0006_d_10} project={true} />
        <br />
      </div>
