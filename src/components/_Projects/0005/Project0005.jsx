  ...
  return (
    <section className='project'>
      <div className="container">
        ...
        <Title content={MOCK.p_0005_title} />

        <Description content={MOCK.p_0005_d_1} project={true} />
        <br />
        ...
        <Description content={MOCK.p_0005_d_2} project={true} />
        <br />
        <Description content={MOCK.p_0005_d_3} project={true} />
        <br />
        ...
        <Description content={MOCK.p_0005_d_4} project={true} />
        <br />
        <Description content={MOCK.p_0005_d_5} project={true} />
        <br />
      </div>
      ...
      <div className="container">
        <Description content={MOCK.p_0005_d_6} project={true} />
        <br />
        <Description content={MOCK.p_0005_d_7} project={true} />
        <br />
        <Description content={MOCK.p_0005_d_8} project={true} />
        <br />
        <Description content={MOCK.p_0005_d_9} project={true} />
        <br />
        <Description content={MOCK.p_0005_d_10} project={true} />
        <br />
        ...
        <Description content={MOCK.p_0005_d_11} project={true} />
        <br />
        <Description content={MOCK.p_0005_d_12} project={true} />
        <br />
        <Description content={MOCK.p_0005_d_13} project={true} />
        <br />
        <Description content={MOCK.p_0005_d_14} project={true} />
        <br />
        <Description content={MOCK.p_0005_d_15} project={true} />
        <br />
        <Description content={MOCK.p_0005_d_16} project={true} />
        <br />
        ...
        <Description content={MOCK.p_0005_d_17} project={true} />
        <br />
