...
export const Project0005 = () => {
  ...
  return (
    <section className='project container'>
      <Title content={'Fantasy Mix'} />

      <div className='project__content'>
        <Image src='https://ambstone.com/wp-content/uploads/2021/07/fantasyMix.jpg' project={true} />

        <div className="project__description">
          <Description content={'Fantasy mix - brown tones of this material give room some rigor, fill it classic comfort, harmony and tranquility. Made by nature, brown brights captivate naturalness.'} project={true} />
